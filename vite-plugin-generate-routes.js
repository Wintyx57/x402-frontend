  ...
  return {
    ...
    closeBundle() {
      ...
      for (const route of STATIC_ROUTES) {
        ...
        // Always generate as directory/index.html (e.g. about/index.html)
        // This works without cleanUrls and avoids conflicts with SPA rewrites
        const outputPath = path.join(distDir, routeName, 'index.html');
