...
def my_function(query: str) -> dict:
  ...
  privacy: {
    ...
    retentionLogsDesc: "Conserves 90 jours pour le monitoring, puis automatiquement supprimes.",
    ...
    retentionMonitorDesc: "Conserves 90 jours pour les statistiques de disponibilite, puis automatiquement nettoyes.",
  ...
  reviews: {
    ...
    error: "Echec de la soumission. Veuillez reessayer.",
