export const fr = {
  ...
  faq: {
    ...
    a8: "Base (Coinbase L2) pour les transactions standard (~$0.001 gas) et SKALE on Base pour les transactions a gas ultra-bas (~$0,0007/tx). Les deux reseaux supportent les paiements USDC.",
...
def my_function(query: str) -> dict:
  ...
  terms: {
    ...
    paymentsGasDesc: "Les frais de gas du reseau (le cas echeant) sont payes par l'appelant et sont separes des prix API. SKALE a des frais de gas ultra-bas (~$0,0007/tx) ; Base facture ~$0.001 par transaction.",
