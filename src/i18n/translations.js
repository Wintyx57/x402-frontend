export const translations = {
  en: {
    ...
    home: {
      ...
      cliHint: "One command to connect your AI agent. Auto-detects your IDE.",
    ...
    integrate: {
      ...
      quickStartCliDesc: "The fastest way to get started. One command auto-detects your IDE, installs the MCP server, and configures everything.",
      quickStartCliNote: "Works with Claude Desktop, Cursor, VS Code + Continue, and Claude Code.",
    ...
    mcp: {
      ...
      quickInstallDesc: "One command does everything: detects your IDE, installs the MCP server, configures your wallet, and verifies the connection.",
      quickFeature1: "Auto-detects IDE",
      quickFeature2: "Configures wallet",
      quickFeature3: "Verifies connection",
    ...
    developers: {
      ...
      cliQuickStartDesc: "Auto-detects your IDE and sets up everything.",
  ...
  fr: {
    ...
    home: {
      ...
      categoriesCount: "Categories",
      cliHint: "Une commande pour connecter votre agent IA. Detection auto de votre IDE.",
    ...
    integrate: {
      ...
      quickStartCliDesc: "Le moyen le plus rapide. Une commande detecte votre IDE, installe le serveur MCP et configure tout.",
      quickStartCliNote: "Compatible avec Claude Desktop, Cursor, VS Code + Continue et Claude Code.",
    ...
    mcp: {
      ...
      quickInstallDesc: "Une commande fait tout : detecte votre IDE, installe le serveur MCP, configure votre wallet et verifie la connexion.",
      quickFeature1: "Detection auto IDE",
      quickFeature2: "Configure le wallet",
      quickFeature3: "Verifie la connexion",
    ...
    developers: {
      ...
      cliQuickStartDesc: "Detecte votre IDE et configure tout automatiquement.",
