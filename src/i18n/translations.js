...
def my_function(query: str) -> dict:
    ...
    docs: {
      ...
      nativeSubtitle: "8 production-ready API endpoints built into x402 Bazaar. Real data, real payments, zero configuration.",
...
def my_function(query: str) -> dict:
    ...
    docs: {
      ...
      nativeSubtitle: "8 endpoints API production, integres et maintenus par x402 Bazaar. Donnees reelles, paiements reels, zero configuration.",
