export const translations = {
  en: {
    ...
    creators: {
      ...
      vp5Title: "6 Platform Integrations",
      vp5Desc: "Auto-distributed to MCP, ChatGPT, CLI, LangChain, Telegram, and Auto-GPT.",
      ...
      howStep2Desc: "Your API appears on the marketplace and is auto-distributed to 6 platforms (MCP, ChatGPT, CLI...).",
    ...
    creatorDashboard: {
      ...
      subtitle: "Enter your wallet address to view your registered APIs and revenue.",
      backToPortal: "Creator Portal",
      walletLabel: "Wallet Address",
      searchBtn: "Search",
      searching: "Searching...",
      invalidWallet: "Please enter a valid Ethereum address (0x...)",
      ...
      guideTitle: "How to use this dashboard",
      guideDesc: "Enter the wallet address you used when registering your APIs. We will show all services associated with that address, along with pricing and revenue details.",
    ...
    creatorOnboarding: {
      ...
      step3Desc: "Once listed, your API is automatically distributed to 6 platforms:",
      ...
      step4d3: "Agent pays USDC on Base (or SKALE for zero gas)",
...
def my_function(query: str) -> dict:
  ...
  fr: {
    ...
    creatorDashboard: {
      ...
      subtitle: "Entrez votre adresse wallet pour voir vos APIs enregistrees et vos revenus.",
      backToPortal: "Portail Createur",
      walletLabel: "Adresse Wallet",
      searchBtn: "Rechercher",
      searching: "Recherche...",
      invalidWallet: "Veuillez entrer une adresse Ethereum valide (0x...)",
      ...
      guideTitle: "Comment utiliser ce dashboard",
      guideDesc: "Entrez l'adresse wallet que vous avez utilisee lors de l'enregistrement de vos APIs. Nous afficherons tous les services associes a cette adresse, avec les prix et les details de revenus.",
