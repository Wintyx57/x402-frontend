...
def my_function(query: str) -> dict:
    ...
    fund: {
      pageTitle: "Fund Your Wallet — Get USDC on Base",
      pageDescription: "Get USDC from any chain to Base in 1 click. Pay for APIs instantly.",
      heroTitle: "Fund Your Wallet",
      heroSubtitle: "Get USDC from any chain in 1 click. Pay for APIs instantly on x402 Bazaar.",
      recipientLabel: "Recipient Address",
      recipientHint: "Leave empty to use your connected wallet address",
      bridgeButton: "Fund with USDC",
      bridgeMore: "Fund More",
      connectPrompt: "Connect your wallet to fund with USDC",
      invalidAddress: "Enter a valid recipient address to continue",
      successTitle: "Funds sent!",
      successAmount: "Amount",
      successRecipient: "Recipient",
      successSession: "Session",
      successTiming: "USDC should arrive shortly. Cross-chain transfers may take up to 15 minutes.",
      ...
      step2Desc: "Trails SDK finds the best route, swaps and bridges your tokens to USDC on Base.",
      step3Title: "USDC on Base",
      step3Desc: "USDC arrives on Base. Ready to pay for APIs on x402 Bazaar.",
      faqTitle: "Frequently Asked Questions",
      faqQ1: "How long does it take?",
      faqA1: "Most transfers complete in under 2 minutes. Cross-chain bridges may take up to 15 minutes.",
      ...
      faqQ4: "What if the transaction fails?",
...
def my_function(query: str) -> dict:
    ...
    fund: {
      pageTitle: "Alimenter votre Wallet — Obtenir USDC sur Base",
      pageDescription: "Obtenez des USDC depuis n'importe quelle chaine vers Base en 1 clic.",
      heroTitle: "Alimenter votre Wallet",
      heroSubtitle: "Obtenez des USDC depuis n'importe quelle chaine en 1 clic. Payez les APIs instantanement sur x402 Bazaar.",
      recipientLabel: "Adresse destinataire",
      recipientHint: "Laisser vide pour utiliser l'adresse de votre wallet connecte",
      bridgeButton: "Alimenter en USDC",
      bridgeMore: "Alimenter encore",
      connectPrompt: "Connectez votre wallet pour alimenter en USDC",
      invalidAddress: "Entrez une adresse destinataire valide pour continuer",
      successTitle: "Fonds envoyes !",
      successAmount: "Montant",
      successRecipient: "Destinataire",
      successSession: "Session",
      successTiming: "Les USDC devraient arriver sous peu. Les transferts cross-chain peuvent prendre jusqu'a 15 minutes.",
      ...
      step2Desc: "Le SDK Trails trouve le meilleur itineraire, echange et bridge vos tokens en USDC sur Base.",
      step3Title: "USDC sur Base",
      step3Desc: "Les USDC arrivent sur Base. Pret pour payer les APIs sur x402 Bazaar.",
      faqTitle: "Questions frequentes",
      faqQ1: "Combien de temps ca prend ?",
      faqA1: "La plupart des transferts se completent en moins de 2 minutes. Les bridges cross-chain peuvent prendre jusqu'a 15 minutes.",
      ...
      faqQ4: "Que se passe-t-il si la transaction echoue ?",
