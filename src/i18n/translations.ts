...
def my_function(query: str) -> dict:
  ...
  fr: {
    ...
    faq: {
      ...
      a2: "Oui, vous avez besoin d'un wallet avec de l'USDC sur Base (ou SKALE pour un gas ultra-bas). Vous pouvez utiliser MetaMask, Coinbase Wallet ou tout wallet compatible EVM. Pour les agents IA, nous recommandons le Coinbase SDK.",
      ...
      a14: "Sur Base mainnet, les frais de gas sont ~$0.001 par transaction. Sur SKALE on Base, le gas est ultra-bas (~$0,0007/tx). Vous pouvez choisir votre reseau en configurant votre agent.",
    ...
    compare: {
      ...
      win6Title: "Multi-Chain",
      win6Desc: "Base mainnet + SKALE (gas ultra-bas). Choisissez le reseau qui vous convient.",
...
def my_function(query: str) -> dict:
    ...
    blog: {
      ...
      solution5: "x402 Bazaar supporte les paiements sur deux chaines : Base (le L2 de Coinbase, avec des frais de gas sub-centimes et une finalite en ~2 secondes) et SKALE on Base (avec des frais de gas ultra-bas (~$0,0007/tx)). Cela signifie qu'un appel API peut couter $0.005 et l'agent paie quasi exactement $0.005 — frais de gas minimes. Des micropaiements quasi reels, pour la premiere fois.",
