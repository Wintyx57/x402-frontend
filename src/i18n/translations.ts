export const translations = {
  en: {
    ...
    home: {
      ...
      valuePro4Desc: "Use SKALE on Base for completely gas-free transactions.",
    ...
    faq: {
      ...
      a8: "Base (Coinbase L2) for standard transactions (~$0.001 gas) and SKALE on Base for zero-gas transactions. Both networks support USDC payments.",
      ...
      a14: "On Base mainnet, gas fees are ~$0.001 per transaction. On SKALE on Base, gas is completely free (zero gas). You can choose your preferred network when configuring your agent.",
...
def my_function(query: str) -> dict:
    ...
    about: {
      ...
      skaleDesc: "SKALE on Base is a zero-gas blockchain optimized for Web3 applications. Every transaction is free, making it ideal for high-frequency AI agent interactions. SKALE runs parallel to Base for cost-free operations.",
  ...
  fr: {
    ...
    home: {
      ...
      onSkale: "sur SKALE",
      footerDesc: "La marketplace autonome ou les agents IA découvrent, paient et consomment des services API via le protocole HTTP 402 sur Base & SKALE on Base.",
      ...
      valuePro4Desc: "Utilisez SKALE on Base pour des transactions sans aucun frais de gas.",
    ...
    faq: {
      ...
      a8: "Base (Coinbase L2) pour les transactions standard (~$0.001 gas) et SKALE on Base pour les transactions sans gas. Les deux reseaux supportent les paiements USDC.",
      ...
      a14: "Sur Base mainnet, les frais de gas sont ~$0.001 par transaction. Sur SKALE on Base, le gas est completement gratuit (zero gas). Vous pouvez choisir votre reseau en configurant votre agent.",
...
def my_function(query: str) -> dict:
    ...
    blog: {
      ...
      step4Desc: "L'agent transfere 0.01 USDC a l'adresse specifiee sur Base ou SKALE on Base. Il recoit un hash de transaction :",
    ...
    about: {
      ...
      skaleChainId: "Chain ID : 1187947933",
      skaleDesc: "SKALE on Base est une blockchain sans gaz optimisée pour les applications Web3. Chaque transaction est gratuite, ce qui la rend idéale pour les interactions fréquentes des agents IA. SKALE fonctionne en parallèle avec Base pour des opérations sans frais.",
