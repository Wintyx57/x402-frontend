...
def my_function(query: str) -> dict:
    ...
    fund: {
      ...
      pageDescription: "Bridge USDC from any chain to Base, SKALE, or Polygon in 1 click.",
      heroTitle: "Fund Your Wallet",
      heroSubtitle: "Bridge USDC to Base, SKALE, or Polygon in 1 click. Pay for APIs with ultra-low gas.",
...
def my_function(query: str) -> dict:
    ...
    fund: {
      ...
      pageDescription: "Bridgez USDC vers Base, SKALE ou Polygon en 1 clic.",
      heroTitle: "Alimenter votre Wallet",
      heroSubtitle: "Bridgez USDC vers Base, SKALE ou Polygon en 1 clic. Payez les APIs avec un gas ultra-bas.",
