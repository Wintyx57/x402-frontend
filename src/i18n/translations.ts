...
def my_function(query: str) -> dict:
    ...
    fund: {
      ...
      successTimingBase: "USDC arrives on Base in ~1-2 minutes.",
      successTimingSkale: "IMA bridge takes 5-15 min to deliver to SKALE.",
      successTimingPolygon: "USDC arrives on Polygon in ~2-5 minutes.",
...
def my_function(query: str) -> dict:
    ...
    fund: {
      ...
      successSession: "Session",
      successTimingBase: "USDC arrive sur Base en ~1-2 min.",
      successTimingSkale: "Le bridge IMA prend 5-15 min pour SKALE.",
      successTimingPolygon: "USDC arrive sur Polygon en ~2-5 min.",
