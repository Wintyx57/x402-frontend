...
def my_function(query: str) -> dict:
    ...
    fund: {
      ...
      howTitle: "How It Works",
      step1Title: "Select Any Token",
      step1Desc: "Choose USDC, ETH, or any token from Ethereum, Polygon, Optimism, Arbitrum, or Base.",
      step2Title: "Trails Routes Automatically",
      step2Desc: "Trails SDK swaps and bridges your tokens to Base, then deposits into the IMA bridge to SKALE.",
      ...
      faqA1: "The IMA bridge from Base to SKALE typically takes 5-15 minutes. You can track progress on the SKALE explorer.",
      faqQ2: "What tokens can I bridge from?",
      faqA2: "Any token on Ethereum, Polygon, Optimism, Arbitrum, or Base. Trails automatically finds the best route.",
      faqQ3: "Is there a minimum amount?",
      faqA3: "No minimum. Very small amounts may not be cost-effective due to bridge fees.",
...
def my_function(query: str) -> dict:
    ...
    fund: {
      ...
      howTitle: "Comment ca marche",
      step1Title: "Selectionnez n'importe quel token",
      step1Desc: "Choisissez USDC, ETH ou tout token depuis Ethereum, Polygon, Optimism, Arbitrum ou Base.",
      step2Title: "Trails route automatiquement",
      step2Desc: "Le SDK Trails echange et bridge vos tokens vers Base, puis depose dans le bridge IMA vers SKALE.",
      ...
      faqQ2: "Quels tokens puis-je bridger ?",
      ...
      faqA3: "Pas de minimum. Les tres petits montants peuvent ne pas etre rentables en raison des frais de bridge.",
