export const translations = {
  en: {
    ...
    importOpenAPI: {
      ...
      stepSign: "Sign",
      stepResults: "Done",
      dropzoneTitle: "Drop your OpenAPI spec here",
      dropzoneSubtitle: "JSON or YAML — OpenAPI 2.0, 3.0, or 3.1",
      orUrl: "Or paste a spec URL",
      ...
      defaultPrice: "Default Price (USDC)",
      perCallPrice: "per call",
      walletAddress: "Wallet Address",
      defaultTags: "Default Tags",
      tagsPlaceholder: "weather, data, api",
      importSummary: "Import Summary",
      endpointsToImport: "endpoints to import",
      priceRange: "Price range",
      signAndImport: "Sign & Import",
      signing: "Signing...",
      importing: "Importing...",
      ...
      viewMyApis: "View My APIs",
      connectWalletFirst: "Connect your wallet to import APIs",
      noEndpoints: "No importable endpoints found",
    ...
    importRapidapi: {
      ...
      host: "Host",
      notDetected: "This spec doesn't look like a RapidAPI spec.",
      standardImport: "Try standard import",
      backToImport: "Standard Import",
      backToRegister: "Register",
      parseSpec: "Parse Spec",
      parsing: "Parsing...",
      endpoints: "endpoints found",
      alreadyRegistered: "Already registered",
      defaultPrice: "Default price per call (USDC)",
      tags: "Tags (comma-separated)",
      signImport: "Sign & Import",
      connectFirst: "Connect your wallet first",
      importing: "Importing...",
      success: "Import successful!",
      imported: "services imported",
      skipped: "skipped (already registered)",
      viewServices: "View on x402 Bazaar",
    },
    connect: {
    ...
    myApis: {
      title: "My APIs",
      subtitle: "Manage your listed APIs and track revenue.",
      totalApis: "Total APIs",
      totalEarned: "Total Earned",
      totalCalls: "Total Calls",
      revenueByChain: "Revenue by Chain",
      editService: "Edit Service",
      deleteService: "Delete Service",
      deleteConfirm: "Are you sure you want to delete",
      noApis: "No APIs yet",
      noApisDesc: "List your first API and start earning USDC.",
      registerCta: "Register an API",
      connectRequired: "Connect your wallet",
      connectDesc: "Connect your wallet to see and manage your APIs.",
      edit: "Edit",
      delete: "Delete",
      fieldName: "Name",
    ...
    home: {
      ...
      ctaTitle: "Join the payment infrastructure",
      ctaDesc:
        "Your API, accessible to thousands of AI agents worldwide. 95% revenue. No setup fees.",
      listYourApi: "List Your API",
      ...
      socialProof3: "Multi-Chain: SKALE + Base + Polygon",
      ...
      howStep2Icon: "Pay",
      howStep3Icon: "Use",
      // New hero keys — infrastructure positioning
      heroTitleNew: "Payment Infrastructure for",
      heroTitleHighlightNew: "the Agentic Web",
      heroSubtitleNew:
        "The payment layer for AI agents. Any agent. Any API. Instant micropayments.",
      ...
      heroStatTests: "Tests",
      heroTrustedBy: "Trusted by",
      // New stats keys
      statApis: "APIs Available",
      statPayments: "Payments",
      statProviders: "External Providers",
      ...
      // Final CTA
      finalCtaTitle: "Start building on the agentic web",
      finalCtaDesc:
        "The payment infrastructure is ready. Your AI agent is one request away from any API in the world.",
      ...
      partnerCta: "Learn more about SKALE",
      // Split Hero
      ...
      heroAgentTitle1: "Any agent.",
      heroAgentTitle2: "Any API.",
      heroAgentTitle3: "Instant pay.",
      heroAgentDesc:
        "The payment layer for autonomous agents. Discover, pay, and consume APIs in a single request — no keys, no subscriptions.",
    ...
    faq: {
      ...
      a1: "x402 Bazaar is an autonomous API marketplace where AI agents discover, pay for, and consume services using the HTTP 402 protocol. Payments are made in USDC on SKALE, Base or Polygon — no accounts, no subscriptions.",
      q2: "Do I need a crypto wallet to use it?",
      a2: "Yes, you need a wallet with USDC on SKALE, Base, or Polygon. You can use MetaMask, Coinbase Wallet, or any EVM-compatible wallet. For AI agents, we recommend the Coinbase SDK for programmatic payments.",
      ...
      a8: "Base (Coinbase L2) for standard transactions (~$0.001 gas), SKALE on Base for ultra-low-gas transactions (~$0.0007/tx), and Polygon for fast low-cost transactions (~$0.001 gas, Chain ID 137). All three networks support USDC payments.",
      q9: "How do I list my API on the marketplace?",
      a9: "Go to the Register page, fill in your API details, and sign with your wallet. Registration is free — your service will appear in the marketplace immediately. Alternatively, use our Python template to create a full x402-compatible API endpoint.",
      ...
      a14: "On Base mainnet, gas fees are ~$0.001 per transaction. On SKALE on Base, gas is ultra-low (~$0.0007/tx). On Polygon, gas fees are ~$0.001 per transaction. You can choose your preferred network when configuring your agent.",
    ...
    analytics: {
      ...
      errorLabel: "Unable to load analytics",
      retryLabel: "Retry",
    ...
    creatorOnboarding: {
      ...
      step2d5: "A wallet to sign and verify ownership (no fee required)",
    ...
    credentials: {
      ...
      toggle: "My API requires authentication",
      type: "Auth Type",
      bearer: "Bearer Token",
      ...
      key: "Key / Header Name",
      value: "Value / Secret",
      addMore: "Add credential",
      encrypted: "Encrypted with AES-256-GCM. Never exposed in API responses.",
      showValue: "Show value",
      hideValue: "Hide value",
      keyPlaceholderBearer: "Authorization",
      keyPlaceholderHeader: "X-API-Key",
      keyPlaceholderBasic: "Authorization",
      keyPlaceholderQuery: "api_key",
      valuePlaceholderBearer: "sk-proj-abc...",
      valuePlaceholderHeader: "my-secret-value",
      valuePlaceholderBasic: "username:password",
      valuePlaceholderQuery: "my-secret-key",
    },
    register: {
      ...
      paying: "Requesting wallet signature...",
      ...
      urlHint: "Enter your API's direct endpoint URL, not a proxy or wrapper.",
      duplicateUrlError: "This URL is already registered on the marketplace.",
      batchSuccess: "services registered successfully!",
    },
    quickRegister: {
      ...
      fullRegLabel: "Full Registration",
...
def my_function(query: str) -> dict:
    ...
    fund: {
      ...
      recipientHint: "Leave empty to use your connected wallet address",
      bridgeButtonBase: "Bridge USDC to Base",
      bridgeButtonSkale: "Bridge USDC to SKALE",
      bridgeButtonPolygon: "Bridge USDC to Polygon",
      bridgeMore: "Bridge More",
      connectPrompt: "Connect your wallet to bridge USDC",
      invalidAddress: "Enter a valid recipient address to continue",
      successTitle: "Bridge initiated!",
      successAmount: "Amount",
      successRecipient: "Recipient",
      successSession: "Session",
      successTimingBase: "USDC arrives on Base in ~10-30 seconds.",
      successTimingSkale: "IMA bridge delivers to SKALE in ~15-45 seconds.",
      successTimingPolygon: "USDC arrives on Polygon in ~10-30 seconds.",
      ...
      progressStep1: "Broadcasting...",
      progressStep2: "Confirming on source chain...",
    ...
    liveAgent: {
      ...
      issCrew: "{count} astronauts aboard",
      spacexTitle: "Next SpaceX Launch",
      spacexCountdown: "T-minus",
      txLabel: "Transaction",
      paid: "Paid",
      totalCost: "Total cost per run",
      runsPerDay: "2 runs/day",
      ...
      ctaSubtitle: "5 minutes to deploy an autonomous API-consuming agent",
      ctaButton: "Get Started",
      noData: "Agent hasn't run yet. First report coming soon...",
    },
    paymentLinks: {
      ...
      viewMyLinks: "View My Links",
      paywall: {
        title: "Content Locked",
        locked: "Content Locked",
        payAccess: "Pay & Access",
        paying: "Waiting for wallet approval...",
        success: "Payment Confirmed!",
        inactive: "Link No Longer Active",
        redirecting: "Open Content",
      },
    },
    simpleMode: {
      simple: "Simple",
      advanced: "Advanced",
      tooltipSimple: "Payments handled automatically",
      tooltipAdvanced: "Full blockchain controls",
    ...
    useCases: {
      badge: "Workflows",
      title: "Payment Infrastructure for the Agentic Web",
      subtitle:
        "See how autonomous agents chain multiple APIs to complete real tasks — paying fractions of a cent per step.",
      workflow1Title: "Research Agent",
      workflow1Desc:
        "An agent that finds articles, extracts content, and synthesizes a summary report on any topic.",
      workflow1Cost: "$0.015 total",
      workflow1Step1Label: "Search",
      workflow1Step1Desc: "Find relevant articles",
      workflow1Step2Label: "Scrape",
      workflow1Step2Desc: "Extract clean content",
      workflow1Step3Label: "Summarize",
      workflow1Step3Desc: "AI-powered summary",
      workflow2Title: "Image Generation Agent",
      workflow2Desc:
        "An agent that generates high-quality images from text descriptions using Gemini.",
      workflow2Cost: "$0.02 total",
      workflow2Step1Label: "Generate",
      workflow2Step1Desc: "Text-to-image via Gemini",
      workflow3Title: "Data Enrichment Agent",
      workflow3Desc:
        "An agent that fetches news, measures sentiment, and correlates market data in one pipeline.",
      workflow3Cost: "$0.025 total",
      workflow3Step1Label: "News",
      workflow3Step1Desc: "Latest headlines",
      workflow3Step2Label: "Sentiment",
      workflow3Step2Desc: "Analyze tone",
      workflow3Step3Label: "Stocks",
      workflow3Step3Desc: "Market data",
      tryBtn: "Try it now",
      copyBtn: "Copy",
      copiedBtn: "Copied!",
      sdkLabel: "Python SDK",
      ...
      perRun: "per run",
      viewPlayground: "Open Playground",
      viewDocs: "Read the docs",
      ctaTitle: "Build your first agent in 5 minutes",
      ctaDesc:
        "Install the SDK, fund your account with a few cents, and start chaining APIs autonomously.",
  ...
  fr: {
    ...
    importOpenAPI: {
      ...
      stepSign: "Signer",
      stepResults: "Terminé",
      dropzoneTitle: "Déposez votre spec OpenAPI ici",
      dropzoneSubtitle: "JSON ou YAML — OpenAPI 2.0, 3.0 ou 3.1",
      orUrl: "Ou collez une URL de spec",
      urlPlaceholder: "https://api.example.com/openapi.json",
      parseSpec: "Analyser la spec",
      parsing: "Analyse...",
      endpointsFound: "endpoints trouvés",
      alreadyRegistered: "déjà enregistrés",
      selectAll: "Tout sélectionner",
      deselectAll: "Tout désélectionner",
      defaultPrice: "Prix par défaut (USDC)",
      perCallPrice: "par appel",
      walletAddress: "Adresse du wallet",
      defaultTags: "Tags par défaut",
      tagsPlaceholder: "météo, données, api",
      importSummary: "Résumé de l'import",
      endpointsToImport: "endpoints à importer",
      priceRange: "Fourchette de prix",
      signAndImport: "Signer & Importer",
      signing: "Signature...",
      ...
      viewMyApis: "Voir mes APIs",
      connectWalletFirst: "Connectez votre wallet pour importer des APIs",
      noEndpoints: "Aucun endpoint importable trouvé",
    ...
    importRapidapi: {
      ...
      host: "Host",
      notDetected: "Cette spec ne semble pas provenir de RapidAPI.",
      standardImport: "Essayer l'import standard",
      backToImport: "Import standard",
      backToRegister: "Enregistrer",
      parseSpec: "Analyser la spec",
      parsing: "Analyse...",
      endpoints: "endpoints trouves",
      alreadyRegistered: "Deja enregistre",
      defaultPrice: "Prix par defaut par appel (USDC)",
      tags: "Tags (separes par des virgules)",
      signImport: "Signer & Importer",
      connectFirst: "Connectez votre wallet d'abord",
      importing: "Import en cours...",
      success: "Import reussi !",
      imported: "services importes",
      skipped: "ignores (deja enregistres)",
      viewServices: "Voir sur x402 Bazaar",
    },
    connect: {
    ...
    myApis: {
      title: "Mes APIs",
      subtitle: "Gerez vos APIs et suivez vos revenus.",
      totalApis: "Total APIs",
      totalEarned: "Total gagne",
      totalCalls: "Total appels",
      revenueByChain: "Revenus par chaine",
      editService: "Modifier le service",
      deleteService: "Supprimer le service",
      deleteConfirm: "Etes-vous sur de vouloir supprimer",
      noApis: "Pas encore d'APIs",
      noApisDesc: "Listez votre premiere API et commencez a gagner des USDC.",
      registerCta: "Enregistrer une API",
      connectRequired: "Connectez votre wallet",
      connectDesc: "Connectez votre wallet pour voir et gerer vos APIs.",
      edit: "Modifier",
      delete: "Supprimer",
      fieldName: "Nom",
      fieldDescription: "Description",
      fieldPrice: "Prix (USDC)",
      fieldTags: "Tags (virgule separateur)",
      save: "Enregistrer",
      ...
      tabPaymentLinks: "Liens de paiement",
    },
    chainSelector: {
    ...
    home: {
      ...
      ctaTitle: "Rejoignez l'infrastructure de paiement",
      ctaDesc:
        "Votre API, accessible a des milliers d'agents IA dans le monde. 95% de revenus. Sans frais d'inscription.",
      listYourApi: "Lister votre API",
      ...
      // Nouvelles cles hero — positionnement infrastructure
      heroTitleNew: "Infrastructure de Paiement pour",
      heroTitleHighlightNew: "le Web Agentique",
      heroSubtitleNew:
        "La couche de paiement pour les agents IA. N'importe quel agent. N'importe quelle API. Micropaiements instantanes.",
      ...
      heroStatBlockchains: "Blockchains",
      heroStatTests: "Tests",
      heroTrustedBy: "Ils nous font confiance",
      // Nouvelles stats
      statApis: "APIs Disponibles",
      statPayments: "Paiements",
      statProviders: "Providers Externes",
      statIntegrations: "Integrations",
      // Labels de section
      howLabel: "Protocole",
      ...
      partnerCta: "En savoir plus sur SKALE",
      // Split Hero
      heroProviderLabel: "Fournisseurs",
      ...
      heroAgentLabel: "Agents IA",
      heroAgentTitle1: "Tout agent.",
      heroAgentTitle2: "Toute API.",
      heroAgentTitle3: "Paiement instantane.",
      heroAgentDesc:
        "La couche de paiement pour les agents autonomes. Decouvrez, payez et consommez des APIs en une requete — sans cle, sans abonnement.",
      heroAgentStat1: "$0.00 gas",
      heroAgentStat2: "3 chaines",
      heroAgentCta: "Parcourir les APIs",
      heroTxnsLabel: "txns sur SKALE",
      heroPoweredBy: "Propulse par",
    ...
    faq: {
      ...
      a1: "x402 Bazaar est une marketplace API autonome ou les agents IA decouvrent, paient et consomment des services via le protocole HTTP 402. Les paiements se font en USDC sur SKALE, Base ou Polygon — pas de comptes, pas d'abonnements.",
      q2: "Ai-je besoin d'un wallet crypto ?",
      a2: "Oui, vous avez besoin d'un wallet avec de l'USDC sur SKALE, Base ou Polygon. Vous pouvez utiliser MetaMask, Coinbase Wallet ou tout wallet compatible EVM. Pour les agents IA, nous recommandons le Coinbase SDK.",
      ...
      a8: "Base (Coinbase L2) pour les transactions standard (~$0.001 gas), SKALE on Base pour les transactions avec gas ultra-bas (~$0,0007/tx), et Polygon pour des transactions rapides et économiques (~$0.001 gas, Chain ID 137). Les trois réseaux supportent les paiements USDC.",
      q9: "Comment lister mon API sur la marketplace ?",
      a9: "Allez sur la page Enregistrer, remplissez les details de votre API et signez avec votre wallet. L'enregistrement est gratuit — votre service apparaitra immediatement. Vous pouvez aussi utiliser notre template Python.",
      ...
      a11: "x402 Bazaar est un projet open-source lance en 2025, avec l'ambition de devenir la plateforme #1 pour le commerce API autonome par agents IA. Le code est public sur GitHub.",
      ...
      a14: "Sur Base mainnet, les frais de gas sont ~$0.001 par transaction. Sur SKALE on Base, le gas est ultra-bas (~$0,0007/tx). Sur Polygon, les frais de gas sont ~$0.001 par transaction. Vous pouvez choisir votre reseau en configurant votre agent.",
    ...
    analytics: {
      ...
      callsLabel: "Appels",
      loadingLabel: "Chargement des analytiques...",
      errorLabel: "Impossible de charger les analytiques",
      retryLabel: "Reessayer",
      recentActivityTitle: "Activite recente",
      activityBreakdown: "Repartition de l'activite",
    },
    compare: {
      badge: "Comparaison",
      title: "x402 Bazaar vs RapidAPI",
    ...
    creatorOnboarding: {
      ...
      step2d5: "Un wallet pour signer et verifier la propriete (aucun frais)",
    ...
    credentials: {
      ...
      toggle: "Mon API nécessite une authentification",
      ...
      keyPlaceholderQuery: "api_key",
      valuePlaceholderBearer: "sk-proj-abc...",
      valuePlaceholderHeader: "ma-valeur-secrete",
      valuePlaceholderBasic: "utilisateur:motdepasse",
      valuePlaceholderQuery: "ma-cle-secrete",
    },
    register: {
      ...
      paying: "Demande de signature wallet...",
      ...
      addAnother: "+ Ajouter un autre outil",
      removeService: "Supprimer",
      serviceCount: "services",
      registerAll: "Tout enregistrer",
      urlHint: "Entrez l'URL directe de votre API, pas un proxy ni un wrapper.",
      duplicateUrlError: "Cette URL est deja enregistree sur le marketplace.",
      batchSuccess: "services enregistres avec succes !",
    },
    quickRegister: {
      ...
      walletLabel: "Adresse de votre Wallet",
      useConnected: "Utiliser le Wallet connecte",
      submit: "Monetiser cette API",
      ...
      fullRegLabel: "Enregistrement Complet",
      quickLabel: "Demarrage Rapide",
    },
    integrate: {
...
def my_function(query: str) -> dict:
    ...
    fund: {
      ...
      bridgeMore: "Bridger encore",
      connectPrompt: "Connectez votre wallet pour bridger des USDC",
      invalidAddress: "Entrez une adresse destinataire valide pour continuer",
      successTitle: "Bridge initie !",
      successAmount: "Montant",
      successRecipient: "Destinataire",
      successSession: "Session",
      successTimingBase: "USDC arrive sur Base en ~10-30 secondes.",
      successTimingSkale: "Le bridge IMA livre sur SKALE en ~15-45 secondes.",
      successTimingPolygon: "USDC arrive sur Polygon en ~10-30 secondes.",
      ...
      progressStep1: "Diffusion...",
      progressStep2: "Confirmation sur la chaine source...",
    ...
    liveAgent: {
      ...
      issCrew: "{count} astronautes a bord",
      spacexTitle: "Prochain lancement SpaceX",
      spacexCountdown: "T-moins",
      txLabel: "Transaction",
      paid: "Paye",
      totalCost: "Cout total par execution",
      runsPerDay: "2 executions/jour",
    ...
    paymentLinks: {
      ...
      success: "Lien de paiement créé !",
      shareLink: "Partagez ce lien",
      copyLink: "Copier le lien",
      createAnother: "Créer un autre",
      viewMyLinks: "Voir mes liens",
      paywall: {
        title: "Contenu verrouillé",
        locked: "Contenu verrouillé",
        payAccess: "Payer & Accéder",
        paying: "En attente de votre portefeuille...",
        success: "Paiement confirmé !",
        inactive: "Lien désactivé",
        redirecting: "Ouvrir le contenu",
      },
    },
    simpleMode: {
      simple: "Simple",
      advanced: "Avancé",
      tooltipSimple: "Paiements gérés automatiquement",
      tooltipAdvanced: "Contrôles blockchain complets",
    ...
    useCases: {
      badge: "Workflows",
      title: "Infrastructure de Paiement pour le Web Agentique",
      subtitle:
        "Découvrez comment des agents autonomes enchainent plusieurs APIs pour accomplir de vraies tâches — en payant des fractions de centime à chaque étape.",
      workflow1Title: "Agent de Recherche",
      workflow1Desc:
        "Un agent qui trouve des articles, extrait le contenu et synthétise un rapport de résumé sur n'importe quel sujet.",
      workflow1Cost: "0,015 $ au total",
      workflow1Step1Label: "Recherche",
      workflow1Step1Desc: "Trouver des articles pertinents",
      workflow1Step2Label: "Extraction",
      workflow1Step2Desc: "Extraire le contenu propre",
      workflow1Step3Label: "Résumé",
      workflow1Step3Desc: "Résumé par IA",
      workflow2Title: "Agent de Génération d'Images",
      workflow2Desc:
        "Un agent qui génère des images de haute qualité à partir de descriptions textuelles via Gemini.",
      workflow2Cost: "0,02 $ au total",
      workflow2Step1Label: "Génération",
      workflow2Step1Desc: "Texte vers image via Gemini",
      workflow3Title: "Agent d'Enrichissement de Données",
      workflow3Desc:
        "Un agent qui récupère des actualités, mesure le sentiment et corrèle les données de marché en un seul pipeline.",
      workflow3Cost: "0,025 $ au total",
      workflow3Step1Label: "Actualités",
      workflow3Step1Desc: "Derniers titres",
      workflow3Step2Label: "Sentiment",
      workflow3Step2Desc: "Analyser le ton",
      workflow3Step3Label: "Actions",
      workflow3Step3Desc: "Données de marché",
      ...
      viewPlayground: "Ouvrir le Playground",
      viewDocs: "Lire la documentation",
      ctaTitle: "Construisez votre premier agent en 5 minutes",
      ctaDesc:
