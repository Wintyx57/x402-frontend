export const translations = {
  en: {
    ...
    home: {
      ...
      onSkale: "on SKALE",
      footerDesc: "The autonomous marketplace where AI agents discover, pay for, and consume API services using the HTTP 402 protocol on Base, SKALE & Polygon.",
      ...
      valuePro3Desc: "Every payment cryptographically verified on Base, SKALE or Polygon. Zero trust required.",
      ...
      socialProof3: "Multi-Chain: Base + SKALE + Polygon",
    ...
    faq: {
      ...
      a1: "x402 Bazaar is an autonomous API marketplace where AI agents discover, pay for, and consume services using the HTTP 402 protocol. Payments are made in USDC on Base, SKALE or Polygon — no accounts, no subscriptions.",
      q2: "Do I need a crypto wallet to use it?",
      a2: "Yes, you need a wallet with USDC on Base, SKALE, or Polygon. You can use MetaMask, Coinbase Wallet, or any EVM-compatible wallet. For AI agents, we recommend the Coinbase SDK for programmatic payments.",
...
def my_function(query: str) -> dict:
    ...
    blog: {
      ...
      step4Desc: "The agent transfers 0.01 USDC to the specified address on Base, SKALE on Base, or Polygon. It receives a transaction hash:",
      ...
      bigPicture3bDesc: "— USDC on L2s (Base, SKALE, Polygon) makes micropayments viable for the first time",
    ...
    about: {
      ...
      whatIsPara2: "AI agents can discover services, negotiate payment automatically, and access APIs without any human intervention. Every transaction is verified on-chain using USDC on Base, SKALE, and Polygon networks, ensuring transparency, trustlessness, and instant settlement.",
      ...
      step2Title: "Pay",
      step2Desc: "Pay per request with USDC on Base, SKALE, or Polygon. No subscriptions, no accounts needed.",
      step3Title: "Use",
    ...
    pricing: {
      ...
      howItWorksPara2: "When your agent calls a paid endpoint, the server responds with HTTP 402 and the exact price. Your agent sends that amount via USDC transfer on Base, SKALE, or Polygon, then retries with proof of payment. Access is granted instantly after on-chain verification.",
      ...
      faqA1: "All payments are made in USDC (USD Coin) on Base, SKALE, or Polygon networks. USDC is a stablecoin pegged 1:1 to the US Dollar.",
    ...
    terms: {
      ...
      paymentsFinalDesc: "All payments are settled on-chain and are irreversible. Once a USDC transfer is confirmed on Base, SKALE, or Polygon, it cannot be refunded.",
      paymentsUsdc: "USDC only",
      paymentsUsdcDesc: "x402 Bazaar exclusively accepts USDC (USD Coin) on Base, SKALE, and Polygon networks. No other tokens or currencies are accepted.",
    ...
    fund: {
      pageTitle: "Fund Your Wallet — Bridge USDC to SKALE",
      pageDescription: "Bridge USDC from any chain to SKALE on Base in 1 click.",
      heroTitle: "Fund Your Wallet",
      heroSubtitle: "Bridge USDC from any chain to SKALE on Base in 1 click. Pay for APIs instantly with ultra-low gas.",
      recipientLabel: "SKALE Recipient Address",
      recipientHint: "Leave empty to use your connected wallet address",
      bridgeButton: "Bridge to SKALE",
      ...
      successTiming: "The IMA bridge typically takes 5-15 minutes to deliver tokens to SKALE.",
      startUsing: "Start using APIs",
      howTitle: "How It Works",
      step1Title: "Choose Any Token",
      step1Desc: "Use any token from any chain. Trails finds the best route to USDC on Base automatically.",
      step2Title: "One-Click Bridge",
      step2Desc: "Trails routes, approves, and bridges to SKALE \u2014 all in one transaction.",
      step3Title: "USDC on SKALE",
      step3Desc: "After 5-15 minutes, USDC arrives on SKALE on Base. Ready for ultra-low gas API payments.",
      faqTitle: "Frequently Asked Questions",
      faqQ1: "How long does the bridge take?",
      faqA1: "The IMA bridge from Base to SKALE typically takes 5-15 minutes.",
      ...
      howItWorksInline: "How it works:",
      howItWorksDesc: "Choose any amount from any chain. Trails routes to Base, approves the SKALE bridge, and calls depositERC20Direct \u2014 all in one transaction.",
    },
    leaderboard: {
      pageTitle: "Leaderboard — x402 Bazaar",
      pageDesc: "Top providers, APIs and payers on the x402 Bazaar marketplace.",
      title: "Leaderboard",
      subtitle: "The most active providers, APIs, and payers on x402 Bazaar.",
      live: "LIVE",
      cacheHint: "Refreshed every 5 minutes",
      tabProviders: "Top Providers",
      tabApis: "Top APIs",
      tabPayers: "Top Payers",
      rankLabel: "#",
      providerNameLabel: "Provider",
      earnedLabel: "Earned (USDC)",
      apiCountLabel: "APIs",
      apiNameLabel: "API",
      categoryLabel: "Category",
      callsLabel: "Calls",
      revenueLabel: "Revenue (USDC)",
      payerLabel: "Payer",
      spentLabel: "Spent (USDC)",
      callCountLabel: "Calls",
      emptyProviders: "No provider data yet.",
      emptyApis: "No API call data yet.",
      emptyPayers: "No payer data yet.",
  ...
  fr: {
    ...
    home: {
      ...
      onSkale: "sur SKALE",
      footerDesc: "La marketplace autonome ou les agents IA découvrent, paient et consomment des services API via le protocole HTTP 402 sur Base, SKALE & Polygon.",
      ...
      valuePro3Desc: "Chaque paiement verifie cryptographiquement sur Base, SKALE ou Polygon. Aucune confiance requise.",
    ...
    faq: {
      ...
      a1: "x402 Bazaar est une marketplace API autonome ou les agents IA decouvrent, paient et consomment des services via le protocole HTTP 402. Les paiements se font en USDC sur Base, SKALE ou Polygon — pas de comptes, pas d'abonnements.",
      q2: "Ai-je besoin d'un wallet crypto ?",
      a2: "Oui, vous avez besoin d'un wallet avec de l'USDC sur Base, SKALE ou Polygon. Vous pouvez utiliser MetaMask, Coinbase Wallet ou tout wallet compatible EVM. Pour les agents IA, nous recommandons le Coinbase SDK.",
...
def my_function(query: str) -> dict:
    ...
    blog: {
      ...
      step4Desc: "L'agent transfere 0.01 USDC a l'adresse specifiee sur Base, SKALE on Base ou Polygon. Il recoit un hash de transaction :",
      ...
      bigPicture3bDesc: "— l'USDC sur les L2 (Base, SKALE, Polygon) rend les micropaiements viables pour la premiere fois",
    ...
    about: {
      ...
      step2Title: "Payez",
      step2Desc: "Payez par requête en USDC sur Base, SKALE ou Polygon. Pas d'abonnements, pas de comptes nécessaires.",
      step3Title: "Utilisez",
    ...
    pricing: {
      ...
      howItWorksPara2: "Quand votre agent appelle un endpoint payant, le serveur répond avec HTTP 402 et le prix exact. Votre agent envoie ce montant via transfert USDC sur Base, SKALE ou Polygon, puis réessaie avec preuve de paiement. L'accès est accordé instantanément après vérification on-chain.",
      ...
      tierMicro: "Micro",
      allEndpointsNote: "Les 69+ endpoints natifs sont en production avec paiements USDC reels.",
      ...
      skaleChainId: "Chain ID : 1187947933",
      skaleDesc: "SKALE a des frais de gas ultra-bas (~$0,0007/tx). Les transactions coûtent ~$0,0007, ce qui la rend idéale pour les opérations d'agents à haute fréquence.",
      ...
      faqA1: "Tous les paiements sont effectués en USDC (USD Coin) sur les réseaux Base, SKALE ou Polygon. L'USDC est un stablecoin indexé 1:1 sur le dollar américain.",
      faqQ2: "Y a-t-il un montant minimum de paiement ?",
      faqA2: "Aucun minimum. Les APIs natives vont de $0.001 a $0.05 par requete pour 69+ endpoints. Les APIs tierces fixent leurs propres prix.",
      faqQ3: "Quelle est la vitesse des transactions ?",
      faqA3: "Les transactions Base sont finalisées en ~2 secondes. Les transactions SKALE sont instantanées et ultra-peu coûteuses (~$0,0007). La vérification du paiement se fait immédiatement après confirmation on-chain.",
      ...
      calcTotal: "Total",
      calcCalls: "appels",
      calcSkaleSave: "Economisez jusqu'a 99% de gas avec SKALE →",
    },
    terms: {
      ...
      paymentsFinalDesc: "Tous les paiements sont regles on-chain et sont irreversibles. Une fois un transfert USDC confirme sur Base, SKALE ou Polygon, il ne peut pas etre rembourse.",
      paymentsUsdc: "USDC uniquement",
      paymentsUsdcDesc: "x402 Bazaar accepte exclusivement l'USDC (USD Coin) sur les reseaux Base, SKALE et Polygon. Aucun autre token ou devise n'est accepte.",
    ...
    fund: {
      pageTitle: "Alimenter votre Wallet — Bridge USDC vers SKALE",
      pageDescription: "Bridgez USDC depuis n'importe quelle chaine vers SKALE on Base en 1 clic.",
      heroTitle: "Alimenter votre Wallet",
      heroSubtitle: "Bridgez USDC depuis n'importe quelle chaine vers SKALE on Base en 1 clic. Payez les APIs instantanement avec un gas ultra-bas.",
      recipientLabel: "Adresse destinataire SKALE",
      recipientHint: "Laisser vide pour utiliser l'adresse de votre wallet connecte",
      bridgeButton: "Bridger vers SKALE",
      ...
      successSession: "Session",
      successTiming: "Le bridge IMA prend generalement 5-15 minutes pour livrer les tokens sur SKALE.",
      startUsing: "Commencer a utiliser les APIs",
      howTitle: "Comment ca marche",
      step1Title: "Choisissez n'importe quel token",
      step1Desc: "Utilisez n'importe quel token depuis n'importe quelle chain. Trails trouve le meilleur itineraire vers USDC sur Base.",
      step2Title: "Bridge en 1 clic",
      step2Desc: "Trails route, approuve et bridge vers SKALE \u2014 le tout en une seule transaction.",
      step3Title: "USDC sur SKALE",
      step3Desc: "Apres 5-15 minutes, les USDC arrivent sur SKALE on Base. Pret pour les paiements API a gas ultra-bas.",
      faqTitle: "Questions frequentes",
      faqQ1: "Combien de temps prend le bridge ?",
      faqA1: "Le bridge IMA de Base vers SKALE prend generalement 5-15 minutes.",
      ...
      howItWorksInline: "Comment ca marche :",
      howItWorksDesc: "Choisissez n'importe quel montant depuis n'importe quelle chain. Trails route vers Base, approuve le bridge SKALE et appelle depositERC20Direct \u2014 le tout en une seule transaction.",
    },
    leaderboard: {
      pageTitle: "Classement — x402 Bazaar",
      pageDesc: "Les meilleurs fournisseurs, APIs et payeurs sur la marketplace x402 Bazaar.",
      title: "Classement",
      subtitle: "Les fournisseurs, APIs et payeurs les plus actifs sur x402 Bazaar.",
      live: "EN DIRECT",
      cacheHint: "Actualisé toutes les 5 minutes",
      tabProviders: "Top Fournisseurs",
      tabApis: "Top APIs",
      tabPayers: "Top Payeurs",
      rankLabel: "#",
      providerNameLabel: "Fournisseur",
      earnedLabel: "Gagné (USDC)",
      apiCountLabel: "APIs",
      apiNameLabel: "API",
      categoryLabel: "Catégorie",
      callsLabel: "Appels",
      revenueLabel: "Revenu (USDC)",
      payerLabel: "Payeur",
      spentLabel: "Dépensé (USDC)",
      callCountLabel: "Appels",
      emptyProviders: "Aucune donnée fournisseur pour l'instant.",
      emptyApis: "Aucune donnée d'appels API pour l'instant.",
      emptyPayers: "Aucune donnée payeur pour l'instant.",
