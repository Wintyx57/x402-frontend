...
function parseMarkdown(markdown: string): string {
  ...
  html = html.replace(/(<li class="list-disc ml-6">.*?<\/li>)/s, (match) => {
  ...
  html = html.replace(/(<li class="list-decimal ml-6">.*?<\/li>)/s, (match) => {
...
export default function BlogArticle() {
  ...
  useSEO({
    ...
    description:
      ...
      metadata.title ||
      "Read the latest article from x402 Bazaar — AI agents, HTTP 402 protocol and USDC micropayments.",
    ogType: "article",
  });
