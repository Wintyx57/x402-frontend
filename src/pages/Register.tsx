...
export default function Register() {
  useSEO({
    ...
    description:
      "List your API, import from OpenAPI or RapidAPI, or create a payment link. Start earning USDC in minutes.",
  });
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/set-state-in-effect -- intentional: syncs URL param to local state on mount/navigation
      ...
      <div className="relative z-[2] max-w-[1200px] mx-auto px-6 pt-16 pb-24">
        ...
        <div className="text-center mb-16">
          ...
          <div className="hero-title-wrap">
            <div className="hero-title-shadow" aria-hidden="true">
              Monetize Your API
            </div>
            <div className="hero-title-shadow" aria-hidden="true">
              Monetize Your API
          ...
          <p className="text-lg text-gray-400 max-w-[500px] mx-auto leading-relaxed">
            Start earning USDC in minutes. Choose how you want to list your
            service.
          </p>
        </div>
        ...
        <div className="flex justify-center gap-12 mt-12 pt-8 relative flex-wrap">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to right, transparent, rgba(255,153,0,0.2), transparent)",
            }}
            aria-hidden="true"
          />
