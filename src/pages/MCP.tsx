...
const tools = [
  {
    ...
    cost: "0.05 USDC",
    desc_en: "Search APIs by keyword (weather, crypto, ai...)",
    desc_fr: "Rechercher des APIs par mot-clé (météo, crypto, IA...)",
  },
  {
    name: "list_services",
    cost: "0.05 USDC",
    desc_en: "List the full catalog of available services",
    desc_fr: "Lister le catalogue complet des services",
  },
  {
    name: "find_tool_for_task",
    cost: "0.05 USDC",
    desc_en:
      "Describe what you need in plain English, get the best API ready to call",
    desc_fr:
      "Décrivez votre besoin en langage naturel, obtenez la meilleure API prête à appeler",
  },
  {
    name: "call_service",
    cost: "Variable",
    desc_en: "Call a registered marketplace service with automatic payment",
    desc_fr: "Appeler un service du marketplace avec paiement automatique",
  },
  {
    name: "call_api",
    cost: "Variable",
    desc_en: "Call any external API URL and return the response",
    desc_fr: "Appeler une API externe et retourner la réponse",
  },
  {
    name: "get_wallet_balance",
    cost: "Free",
    desc_en: "Check agent USDC balance on Base, SKALE or Polygon",
    desc_fr: "Vérifier le solde USDC de l'agent sur Base, SKALE ou Polygon",
  },
  {
    name: "setup_wallet",
    cost: "Free",
    desc_en: "Generate or configure agent wallet for payments",
    desc_fr: "Générer ou configurer le portefeuille agent pour les paiements",
  },
  {
    name: "export_private_key",
    cost: "Free",
    desc_en: "Export the agent wallet private key (use with caution)",
    desc_fr:
      "Exporter la clé privée du portefeuille agent (à utiliser avec précaution)",
  },
  {
    name: "get_budget_status",
    cost: "Free",
    desc_en: "Check session spending, remaining budget and payment history",
    desc_fr: "Vérifier les dépenses de session, budget restant et historique",
  },
  {
    name: "discover_marketplace",
    cost: "Free",
    desc_en: "Discover the marketplace, available endpoints and total services",
    desc_fr: "Découvrir la marketplace, endpoints et nombre de services",
  },
  {
    name: "import_openapi",
    cost: "Free",
    desc_en: "Import an OpenAPI spec to register multiple endpoints at once",
    desc_fr:
      "Importer une spec OpenAPI pour enregistrer plusieurs endpoints d'un coup",
  },
  {
    name: "create_payment_link",
    cost: "Free",
    desc_en: "Create a shareable payment link for any content or URL",
    desc_fr: "Créer un lien de paiement partageable pour tout contenu ou URL",
  },
  {
    name: "access_payment_link",
    cost: "Variable",
    desc_en: "Pay and access a payment link to reveal its content",
    desc_fr: "Payer et accéder à un lien de paiement pour révéler son contenu",
  },
];
...
export default function MCP() {
  ...
  useSEO({
    ...
    description:
      "Use x402 Bazaar as an MCP server. Connect Claude, Cursor or VS Code to 100+ paid APIs. AI agents pay autonomously with USDC on Base or SKALE. Auto-wallet generation, 15 MCP tools, plug-and-play setup.",
    keywords:
      "MCP server x402, Claude MCP marketplace, Cursor MCP integration, AI agent MCP tools, Model Context Protocol payments, MCP USDC, Claude tools marketplace",
  });
    ...
    <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="glass-card rounded-xl p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="bg-white/5 rounded-lg p-4 flex flex-col items-center text-center">
              <svg
                className="w-8 h-8 text-[#FF9900] mb-2"
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
                strokeWidth="1.5"
      ...
      <section className="mb-12" ref={reveal}>
        ...
        <div className="space-y-3">
          {tools.map((tool) => (
            <div
              key={tool.name}
              className="glass-card rounded-xl p-3 sm:p-4 flex flex-col sm:flex-row sm:items-start gap-2 sm:gap-4"
            >
              <div className="flex items-center justify-between sm:contents gap-2">
                ...
                <span
                  className={`shrink-0 text-xs font-mono font-bold px-2 py-1 rounded sm:order-last ${
                    tool.cost === "Free"
              ...
              <div className="flex-1 min-w-0">
                <p className="text-gray-300 text-sm">
                  {lang === "fr" ? tool.desc_fr : tool.desc_en}
                </p>
              </div>
            </div>
          ))}
      ...
      <section className="mb-12" ref={reveal}>
        ...
        <div className="glass-card rounded-xl p-6">
          ...
          <div className="space-y-4">
            {[m.walletStep1, m.walletStep2, m.walletStep3, m.walletStep4].map(
              (step, i) => (
                <div key={i} className="flex items-start gap-3">
        ...
        <div className="glass-card rounded-xl p-6">
          ...
          <div className="bg-[#0d1117] border border-white/10 rounded-xl p-4">
            <p className="text-gray-500 text-xs font-mono mb-2">
              {m.securityConfigLabel}
            </p>
            <code className="text-[#FF9900] text-sm font-mono">
              MAX_BUDGET_USDC=1.00
            </code>
      ...
      <section className="mb-12" ref={reveal}>
        ...
        <div className="rounded-xl border-2 border-[#FF9900]/30 bg-gradient-to-br from-[#FF9900]/[0.06] to-transparent p-6 mb-6">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="ml-auto text-xs font-medium text-[#34D399] bg-[#34D399]/10 px-2 py-0.5 rounded-full">
              {m.quickInstallBadge}
            </span>
          </div>
        ...
        <div className="glass-card rounded-xl p-5 mb-6">
          ...
          <div className="flex flex-wrap gap-2">
            {ides.map((ide) => (
              <div
                key={ide.id}
                className="flex items-center gap-2 px-3 py-2 rounded-lg bg-white/5 text-gray-300 text-sm"
              >
                <span>{ide.icon}</span>
                {ide.name}
              </div>
        ...
        <div className="glass-card rounded-xl overflow-hidden">
          ...
          >
            ...
            <svg
              className={`w-5 h-5 text-gray-500 transition-transform duration-200 ${showManual ? "rotate-180" : ""}`}
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
              strokeWidth="2"
