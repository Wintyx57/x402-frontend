            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a href="https://x.com/x402_bazaar" target="_blank" rel="noopener noreferrer"
                     className="text-gray-500 hover:text-white transition-colors">
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                    </svg>
                  </a>
                  <a href="mailto:contact.x402bazaar@gmail.com"
                     className="text-gray-500 hover:text-white transition-colors">
      ...
      <section ref={contactRef} className="reveal mb-10">
        ...
        <div className="glass rounded-xl p-6 space-y-4">
          <div className="flex items-center gap-3 text-sm">
            ...
            <a href="mailto:contact.x402bazaar@gmail.com" className="text-gray-300 hover:text-white transition-colors">
          ...
          <div className="flex items-center gap-3 text-sm">
            ...
            <a href="https://x.com/x402_bazaar" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors">
              @x402_bazaar
            </a>
          </div>
          <div className="flex items-center gap-3 text-sm">
