...
export default function About() {
  ...
  useSEO({
    ...
    description:
      "Learn how x402 Bazaar works: the first autonomous API marketplace where AI agents pay per call with USDC using the HTTP 402 protocol. Our mission, architecture, security model and 100+ service ecosystem on Base, SKALE and Polygon.",
    keywords:
      "about x402 Bazaar, HTTP 402 protocol marketplace, AI agent economy, USDC API payments, x402 mission, who built x402",
  });
  ...
  useEffect(() => {
    ...
    fetch(`${API_URL}/api/services`, { signal: controller.signal })
      ...
      .then((data) => {
        ...
        list.forEach((s: Record<string, any>) =>
          (s.tags || []).forEach((tag: string) => {
            if (tag !== "x402-native" && tag !== "live") cats.add(tag);
          }),
        );
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10">
          ...
          {[
            {
              ...
              desc: t.about.step1Desc
                .replace("{count}", String(serviceCount))
                .replace("{catCount}", String(catCount)),
              icon: "search",
            },
            {
              num: "2",
        ...
        <div className="space-y-4">
          ...
          <div className="glass-card rounded-lg p-6 border border-blue-500/10">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <p className="text-gray-500 text-xs">
                  {t.about.baseChainId}: {CHAIN_CONFIG[8453].key}
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-2 text-xs">
              <span className="glass px-3 py-1 rounded-full text-gray-400">
                {t.about.baseFeature1}
              </span>
              <span className="glass px-3 py-1 rounded-full text-gray-400">
                {t.about.baseFeature2}
              </span>
              <span className="glass px-3 py-1 rounded-full text-gray-400">
                {t.about.baseFeature3}
              </span>
            </div>
          </div>
          ...
          <div className="glass-card rounded-lg p-6 border border-green-500/10">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <p className="text-gray-500 text-xs">
                  {t.about.skaleChainId}: {CHAIN_CONFIG[1187947933].key}
                </p>
              </div>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed mb-3">
            ...
            <div className="flex flex-wrap gap-2 text-xs">
              <span className="glass px-3 py-1 rounded-full text-green-400">
                {t.about.skaleFeature1}
              </span>
              <span className="glass px-3 py-1 rounded-full text-gray-400">
                {t.about.skaleFeature2}
              </span>
              <span className="glass px-3 py-1 rounded-full text-gray-400">
                {t.about.skaleFeature3}
              </span>
            </div>
          </div>
        </div>
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-white font-semibold text-sm">
                  {t.about.frontendRepo}
                </h3>
              </div>
              <p className="text-gray-500 text-xs">
                {t.about.frontendRepoDesc}
              </p>
            </a>
            <a
      ...
      <section ref={slaRef} className="reveal mb-10">
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          {[
            ...
            <div
              key={item.title}
              className={`glass-card rounded-lg p-4 flex gap-3 border ${item.border}`}
            >
              <div
                className={`w-9 h-9 rounded-full flex items-center justify-center shrink-0 ${item.color} ${item.bg}`}
              >
                {item.icon}
              </div>
              <div>
      ...
      <section ref={identityRef} className="reveal mb-10">
        <h2 className="text-2xl font-bold text-white mb-2">
          {t.about.onChainIdentityTitle}
        </h2>
        <p className="text-gray-400 text-sm mb-5">
          {t.about.onChainIdentityDesc}
        </p>
        <div className="glass rounded-xl p-6 space-y-4 text-gray-300 text-sm leading-relaxed">
      ...
      <section ref={teamRef} className="reveal mb-10">
        ...
        <div className="glass rounded-xl p-6 space-y-5 text-gray-300 text-sm leading-relaxed">
          ...
          <div className="glass-card rounded-xl p-5 border border-[#FF9900]/15">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-white font-semibold text-base">
                  {t.about.founderName || "Robin"}
                </h3>
                <p className="text-[#FF9900] text-xs font-medium mb-2">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a
                    href="mailto:contact.x402bazaar@gmail.com"
                    className="text-gray-500 hover:text-white transition-colors"
                  >
                    <svg
                      className="w-4 h-4"
          ...
          <div className="glass-card rounded-lg p-4 border border-[#FF9900]/10 flex items-center gap-3">
            ...
            <div>
              <h3 className="text-white font-semibold text-sm">
                {t.about.teamHackathon}
              </h3>
              <p className="text-gray-500 text-xs">
                {t.about.teamHackathonDesc}
              </p>
            </div>
          </div>
        </div>
