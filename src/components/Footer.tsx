...
export default function Footer() {
  ...
  return (
    <footer
      className="border-t border-white/8 bg-gradient-to-b from-[#131921] to-[#0e1117]"
      role="contentinfo"
    >
      <div className="max-w-7xl mx-auto px-4 py-10">
        ...
        <div className="border-t border-white/5 pt-6 flex flex-wrap items-center justify-between gap-4">
          <p className="text-xs text-gray-400">
            ...
            &middot; Powered by{" "}
            <SkaleLogo className="w-3.5 h-3.5 inline-block align-text-bottom rounded-sm" />{" "}
            <span className="text-[#34D399]">SKALE</span>,{" "}
            <BaseLogo className="w-3.5 h-3.5 inline-block align-text-bottom" />{" "}
            Base &amp;{" "}
            <PolygonLogo className="w-3.5 h-3.5 inline-block align-text-bottom" />{" "}
            Polygon
          </p>
